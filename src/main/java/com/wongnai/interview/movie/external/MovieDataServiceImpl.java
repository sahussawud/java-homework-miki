...
public class MovieDataServiceImpl implements MovieDataService {
	...
	public MoviesResponse fetchAll() {
		...
		ResponseEntity<String> entity = restTemplate.getForEntity(MOVIE_DATA_URL, String.class);
		String body = entity.getBody();
		try {
			MoviesResponse movies = objectMapper.readValue(body,  MoviesResponse.class);
			return movies;
		} catch (IOException e) {
			e.printStackTrace();
		}
